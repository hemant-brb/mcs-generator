...
class GenerateServiceCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'generate:service {tables*}
     ...
     * @var string
     */
    protected $description = "Generates Services for the tables provided in the command.";
    ...
    public function handle() {
        ...
        $service->generateServices($tables);
    }
