...
class GenerateFactoryCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'generate:factory {tables*}
     ...
     * @var string
     */
    protected $description = "Generates Factories for the tables provided in the command.";
    ...
    public function handle() {
        ...
        $service->generateFactories($tables);
    }
