...
class GenerateControllerCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'generate:controller {tables*}
     ...
     * @var string
     */
    protected $description = "Generates Controllers for the tables provided in the command.";
    ...
    public function handle() {
        ...
        $service->generateControllers($tables);
    }
