...
class GenerateSeederCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'generate:seeder {tables*}
     ...
     * @var string
     */
    protected $description = "Generates Seeders for the tables provided in the command.";
    ...
    public function handle() {
        ...
        $service->generateSeeders($tables);
    }
