...
class GenerateExceptionCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'generate:exception {tables*}
     ...
     * @var string
     */
    protected $description = "Generates Exceptions for the tables provided in the command.";
    ...
    public function handle() {
        ...
        $service->generateExceptions($tables);
    }
