...
class GenerateTransformerCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'generate:transformer {tables*}
     ...
     * @var string
     */
    protected $description = "Generates Transformers for the tables provided in the command.";
    ...
    public function handle() {
        ...
        $service->generatorTransformers($tables);
    }
